...
export default {
    ...
    emits: ['update:MovieName', 'update:ReleaseYear', 'update:Genre', 'update:DurationHours', 'update:DurationMinutes']
}
</script>
<template>
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>><input :value="Genre" @input="$emit('update:DurationMinutes',$event.target.value)"></td>
        </tr>
    </table>
</template>